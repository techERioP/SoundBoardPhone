...
def aggiornamento():
    while int(linea_numero) < int(files_download):
        ...
        new_file = lines[int(linea_numero)]
        url = "https://raw.githubusercontent.com/techERioP/SoundBoardPhone/main/serverphoneGUI/build/" + str(new_file)
    ...
    print("update done")
    if messagebox.askyesno("Update "+ version.replace("latest: ", "") + " Completed", "Do you want to close the app?"):
...
def mes_delversion():
    if messagebox.askyesno("Old version found", "Do you want to update to " + version.replace("latest: ", "") + "?"):
        os.remove('gui (1).py')
